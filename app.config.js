...
const config = {
    app: {
        ...
        allowedEmailDomainTLDs: [ 'com', 'net', 'org', 'edu', 'gov', 'mil', 'biz', 'info', 'name', 'museum', 'us', 'uk', 'ca', 'au', 'in', 'co', 'io', 'me', 'xyz', 'tech', 'store', 'online', 'site', 'space', 'website', 'host', 'club', 'shop', 'store'],
    },
    server: {
    ...
    database: {
        mongodb: {
            ...
            database: process.env.MONGODB_DATABASE || 'live-streaming-app',
